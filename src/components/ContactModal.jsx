    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          {/* Modal Container - Proper overflow handling */}
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto">
            ...
            >
              {/* Modal Card with proper height management */}
              <div
                className="relative bg-gradient-to-br from-white to-rose-50/30 rounded-2xl shadow-2xl"
                onClick={(e) => e.stopPropagation()}
              >
                {/* Decorative Header - Fixed height */}
                    ...
                    >
                      ...
                      <div className="pt-2 pb-2">
                        <motion.button
                          ...
                          whileTap={{ scale: 0.98 }}
                          className="w-full py-3 bg-gradient-to-r from-rose-500 to-pink-500 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed text-sm"
                        >
                          {isSubmitting ? (
                            <>
